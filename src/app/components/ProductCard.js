...
const ProductCard = ({ product }) => {
  ...
  return (
    <>
      <div className="bg-gray-800 w-full  rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden sm:max-w-sm sm:mx-auto border border-gray-700">
        <div
        ...
        >
          <Image
            ...
            className="w-auto h-auto max-md:object-contain max-md:h-auto"
          />
        </div>
